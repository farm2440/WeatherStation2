...
# wd_web_emit.py - Watchdog script.
# Тази програма стартира процеса за четене обновяване на уеб интерфейса web_emit.py
...
SCRIPT_PATH = r'/home/svilen/ws2/web_emit.py'
